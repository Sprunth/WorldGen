...
namespace Noise.Modules
{
    public class Billow : Module
    {
        ...
        public Billow() : this(DefaultFrequency, DefaultLacunarity, DefaultQuality, DefaultOctaveCount, DefaultPersistence, DefaultSeed) { }

        public Billow(double frequency, double lacunarity, NoiseQuality quality, uint octaveCount, double persistence, int seed)
        {
            Frequency = frequency;
